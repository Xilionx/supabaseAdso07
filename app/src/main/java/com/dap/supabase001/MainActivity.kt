...
class MainActivity : AppCompatActivity() {
    ...
    var dataset = mutableListOf<ModelCajero>()
    ...
    fun recyclerView(){
        //dataset = arrayOf("January", "February", "March")
    ...
    suspend fun visualiza(){
        withContext(Dispatchers.IO){
            val result = ConexionServiceCajero.visualizaSupabase()
            withContext(Dispatchers.Main){
                model.addAllCajero(result)
